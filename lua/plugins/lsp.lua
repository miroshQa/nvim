...
vim.keymap.set("n", "<leader>j", function() require('telescope.builtin').lsp_document_symbols({symbols = adequate_symbols}) end, { desc = 'Jump to symbol (search)'})
vim.keymap.set("n", "<leader>J", function() require('telescope.builtin').lsp_workspace_symbols({symbols = adequate_symbols}) end, { desc = "Jump to symbol in workspace (search)" })
